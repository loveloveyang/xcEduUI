    ...
    <el-form :model="pageForm" label-width="80px" :rules="pageFormRules" ref="pageForm">
      <el-form-item label="所属站点" prop="siteId">
        <el-select v-model="pageForm.siteId" placeholder="请选择站点">
          <el-option
            v-for="item in siteList" :key="item.siteId" :label="item.siteName" :value="item.siteId"></el-option>
        </el-select>
      </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      go_back() {
        this.$router.push({
          path: '/cms/page/list',
          query: {page: this.$route.query.page, siteId: this.$route.query.siteId}
        })
      }
    },
    ...
    mounted() {
      ...
      this.siteList = [
        ...
        {siteId: '5d8d9d02d7680872649bd695', siteName: '课程详情站点'},
        {siteId: '5d8da12ad7680872649bd6aa', siteName: '课程预览站点'}
      ];
      //模板列表
      this.templateList = [
        {templateId: '5a962b52b00ffc514038faf7', templateName: '首页'},
        {templateId: '5a962bf8b00ffc514038fafa', templateName: '轮播图'},
        {templateId: '5d8d9d02d7680872649bd695', templateName: '课程详情页面'}
      ]
    }
